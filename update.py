...
try:
    print("세금계산서 1건 수정 - 임시저장 상태에서만 가능")
    ...
    result = taxinvoiceService.update(testValue.testCorpNum,MgtKeyType,MgtKey,taxinvoice,writeSpecification,UserID)
